  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
     <div class="text-center align-self-center col-lg-6">
      <div class="container">
        <h1>Web-Hacking Grundlagen</h1>
        <p class="lead text-muted">Hier befinden Testanwendungen für die Sicherheitslücken, welche im Rahmen des Securirty Campus der AWARE7 GmbH vermittelt werden.</p>
        <p>
          <a href="xss.php" class="btn btn-primary my-2">Starte mit XSS</a>
          <a href="https://learning.aware7.de/" class="btn btn-secondary my-2">Zum Campus</a>
        </p>
        <footer class="footer">
    <div class="inner">
