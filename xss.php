  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
     <div class="text-center align-self-center col-lg-6">
        <form class="form-signin" action="xss.php", method="GET">
            <?php
                echo '<h1 class="h3 mb-3 font-weight-normal">Hallo ' . $_GET["name"] . '!</h1>';
            ?>
            <label for="inputEmail" class="sr-only">Name</label>
            <input type="name" id="name" name="name" class="form-control" placeholder="Name" required autofocus>
            <button class="btn btn-lg btn-primary btn-block" type="submit">Send Name</button>
