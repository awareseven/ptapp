        ...
        <form class="form-signin" action="login.php" method="POST">
            ...
            <?php
                if(isset($_POST['username']) AND isset($_POST['password'])){
                  ...
                  $result = $db->query('SELECT * FROM user WHERE username="' . $_POST["username"] . '" AND password="' . $_POST["password"] . '";');
                  
                  if ($result->fetchArray() != FALSE){
                    echo '<h1 class="h3 mb-3 font-weight-normal"> Logged In</h1>';
                  }
                  else{
                    echo '<h1 class="h3 mb-3 font-weight-normal"> Login Failed</h1>';
                  }
                }
